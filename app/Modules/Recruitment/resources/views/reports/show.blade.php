...
<div class="row">
    <div class="col-sm-12">
        <div class="custom-panel">
            ...
            <div class="row">
                <div class="col-md-6">
                    <h2>{{trans('app.recruitment.reports.show.personal_details')}}</h2>
                    <div class="row">
                        <div class="col-md-4">
                ...
                <div class="col-md-6">
                    <h2>{{trans('app.pim.employees.qualifications.work_experience.main')}}</h2>
                ...
                <div class="col-md-6">
                    <h2>{{trans('app.pim.employees.qualifications.education.main')}}</h2>
                ...
                <div class="col-md-6">
                    <h2>{{trans('app.pim.employees.qualifications.languages.main')}}</h2>                
