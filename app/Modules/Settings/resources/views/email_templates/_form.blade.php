<div class="form-group">
    {!! Form::label('name', trans('app.settings.email_templates.name').':', ['class' => 'col-sm-3']) !!}
    <div class="col-sm-6">
        {!! Form::text('name', null, ['class' => 'form-control']) !!}
    </div>
</div>
<div class="form-group">
    {!! Form::label('template', trans('app.settings.email_templates.template').':', ['class' => 'col-sm-3']) !!}
    <div class="col-sm-9">
...
<div class="form-group">
    <div class="col-sm-6 col-sm-offset-3">
        <a href="{{route('settings.email_templates.index')}}" class="btn btn-default">{{trans('app.cancel')}}</a>
