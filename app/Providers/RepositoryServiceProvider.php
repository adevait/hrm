...
class RepositoryServiceProvider extends ServiceProvider
{
    public function register()
    {
        $bindings = [
            ...
            Settings\Repositories\CustomFieldsRepository::class => [Settings\Repositories\Interfaces\CustomFieldsRepositoryInterface::class],
            ...
            Recruitment\Repositories\PersonaRepository::class => [Recruitment\Repositories\Interfaces\PersonaRepositoryInterface::class],
